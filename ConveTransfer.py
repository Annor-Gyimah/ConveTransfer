        ...
        def updates_by_default():
            ...
            try:
                ...
                response = requests.get(
                    'https://annor-gyimah.github.io/soft/Convetransfer_1280_720/updates/version.txt')
        ...
        def check_updates():
            ...
            try:
                ...
                if data > __version__:
                    ...
                    if mb1 is True:
                        # -- Replace the url for your file online with the one below.
                        webbrowser.open_new_tab('https://annor-gyimah.github.io/soft/Convetransfer_1280_720/'
