...
class ChangelogWindow(tk.Toplevel):
    def __init__(self, changelog_text):
        ...
        self.text_widget = scrolledtext.ScrolledText(self, wrap=tk.WORD, width=40, height=20)
        self.text_widget.insert(tk.END, changelog_text)
...
if __name__ == "__main__":
    ...
    def show_changelog():
        ChangelogWindow(changelog_text)

    button = tk.Button(root, text="Show Changelog", command=show_changelog)
    button.pack(pady=20)
