...
class Root(ttk.Window):
    def __init__(self):
        ...
        self.second_frame = ttk.Frame(self.container_frame,width=70)
        self.second_frame.pack(fill='both', side='left', padx=(1, 1), pady=1)
        self.second_frame.pack_forget()
        

        

        self.switch_button = ttk.Button(self.button_frame, text="Switch Frames", command=self.toggle_frames)
        self.switch_button.pack(side=tk.LEFT, padx=1, pady=1) 
        ...
        update_drive_info_and_progress_bars(self.tab2)
