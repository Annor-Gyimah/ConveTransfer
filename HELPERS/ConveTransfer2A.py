...
class Root(ttk.Window):
    ...
    #         self.enable_buttons()
    #     receive_thread = threading.Thread(target=receive_files_in_thread)
            ...
            try:
                ...
                with conn:
                    while True: 
                        ...
                        try:
                            self.filename, total_size = file_info.decode('utf-8', 'ignore').split(",")
                            total_size, total_size1 = int(total_size), int(total_size)
                            # convert = total_size1
                            # if total_size1 < 1024:
                            #     size_units = 'B'
                            #     formatted_size = f"{convert} {size_units}"
