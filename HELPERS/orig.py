...
#         sentnum = ttk.Label(self.entries,text=f'Sent :{sent_count}', font=('Arial',8, 'bold'))
#         sentnum.pack(pady=5)
#         receivenum = ttk.Label(self.entries,text=f'Receive :{received_count}', font=('Arial',8,'bold'))
#         receivenum.pack()
